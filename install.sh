...
modules=(
        barebuf.h       barebuilder.h   barecsv.h       bareencoding.h
        barehttp.h      bareio.h        barejson.h      barelog.h
        baremath.h      barenet.h       bareos.h        barepath.h
        barepool.h      bareproc.h      barecoro.h      baresig.h
        barestd.h       barestrs.h      baresync.h      baretest.h
        barethreads.h   baretime.h      bareutf8.h
)
...
net_modules=(
        barestd.h baretime.h barenet.h baresync.h barethreads.h
)

web_modules=(
        barestd.h baretime.h barenet.h baresync.h barethreads.h
        barebuilder.h barejson.h bareencoding.h barehttp.h
)
...
main() {
        ...
        case $1 in
                ...
                net     ) install_list "${net_modules[@]}" ;;
                web     ) install_list "${web_modules[@]}" ;;
                *       ) install_list "$@" ;;
        esac
}
